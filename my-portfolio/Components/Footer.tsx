import { DevicePhoneMobileIcon, EnvelopeIcon, EnvelopeOpenIcon, MapIcon } from "@heroicons/react/20/solid";
        ...
        <div className="flex items-center space-x-6">
          ...
          <div>
            ...
            <p className="text-[15px] opacity-60 w-[100%] text-white">
              R-40 Al-Noor Society <br /> Near Ahsanabad <br />Scheme, 33 Karachi Pakistan.
            </p>
          </div>
        </div>
